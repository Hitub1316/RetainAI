              ...
              <div className="hero-text">
                ...
                <div className="social-proof">
                  <div className="avatars">
                    <img className="avatar" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCKy5_2rQlGqpcfkeUKJMdlZRaRldrk0JA8A0E3XFrtud2DefLnJxI4YARWO0YAnRonQkhqIfc9RTeP6NPEZmkHY7raCVYaVwKNS_gf8mstQDdR4Ka8Ry4wL36SeNb38nbp4Zht1U4kav7N12aK0_5eK-QJwTLa9q42WFUUpG-qXzGcQQr4Ps_Osa1s8ctke4svGFTl2FUdR8Zi0oRMrkBwpH75M5Tfr2dYSPANUX7frs_v8EXanjutzu6wj30ZuefZn80nMHtaJDa2" alt="User" />
                    <img className="avatar" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAty6SHZFJ51KTUtPg-P6xMSelwMCnApZasjb07HAwXVI_dKS0QYoirKQ4JtjIyxKYd_R5_zPNoKqT8m5ghFX4nCHerawdIdeW5B1z8U01MW2KsYCJgJPUZDnzpn3686X8qpJEIvdZh3GwCmhJx2Doer_TceeCZkNlrFUdsm9bLzhDn1CCvbLwrPVP8WdZ32I9W3A1oOrbeWKDpO6rThBbx5nWv_gzyEXNeIDWyt38KZjyKlAKGM9AEMrhdPBLeP_0WXuVQtne3slGW" alt="User" />
                    <img className="avatar" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDqnKmXKbp3WBsc4FLFMhmuDYzl6mgFpggR9zSj68YsPS08UiybNJnF5ZrqYdprcehR_f6sCmsj8CChhUfYZUNK-qUBMs7bH0tQxg7KBbMrNSwXDSr8s_j72lv8XLLN_zp4S55Pit3daFxtVpEZ8YCg3AMoMJ-WBQT_dRjA1K8ULjbwl3g8rlhYz8vNRg0iuxdFxDgI0n-80dega4sdtqfJMrGVgunnvtzTUIcRbgCfR_SBDe9gcZ3j21DBN897612hG1S1UMvxm-68" alt="User" />
                  </div>
              ...
              <div className="cta-card">
                ...
                <div className="cta-content">
                  ...
                  <div className="cta-actions">
                    ...
                    <Link to="/working" className="btn-outline-white">Talk to Sales</Link>
                  </div>
